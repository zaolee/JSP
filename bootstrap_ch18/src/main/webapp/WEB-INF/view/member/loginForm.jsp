	...
	<div class="login-box">
		...
		<div class="login-box-body">
				...
				<div class="form-group has-feedback">
					<input type="email" class="form-control" name="email"
						placeholder="Email"> <span style="color: red"> <c:if
							test="${errors.email}">ID를 입력하세요.</c:if>
					</span> <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
				</div>
				<div class="form-group has-feedback">
					<input type="password" class="form-control" name="password"
						placeholder="Password"> <span style="color: red"> <c:if
							test="${errors.password}">암호를 입력하세요.</c:if>
					</span> <span class="glyphicon glyphicon-lock form-control-feedback"></span>
				</div>
				<div class="row">
					<div class="col-xs-8">
			...
			<a href="#">I forgot my password</a><br> <a
				href="<%=request.getContextPath()%>/join.do" class="text-center">회원가입</a>
